...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Victory for now",		        "Beat Week 1 on Hard with no Misses.",				'riff_nomiss',			false],
		["Total Failure",		        "Beat Week 1 on Failure Mode.",				'riff_fail',			true],
		["No More Tricks",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			true],
		["Research Failed",		        "Beat Week 2 on Failure Mode.",				'knaill_fail',			true],
		["Call Me The Hitman",			"Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			true],
		["Pyschic Eye Continues",		 "Beat Week 3 on Failure Mode.",				'vandinn_fail',			true],
		["Lady Killer",					"Beat Week 4 on Hard with no Misses.",				'week4_nomiss',			true],
		["Stupidty has hit you",		 "Beat Week 4 on Failure Mode.",				'riz_fail',			true],
...
class AttachedAchievement extends FlxSprite {
	...
	public function reloadAchievementImage() {
		if(Achievements.isAchievementUnlocked(tag)) {
			...
			loadGraphic(Paths.image('achievements/lockedFrame'));
		}
		scale.set(0.7, 0.7);
		updateHitbox();
	}
